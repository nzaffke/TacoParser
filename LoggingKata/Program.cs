...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (var locA = 0; locA < locations.Length; locA++)
            {
                ...
                for (var locB = 0; locB < locations.Length; locB++)
                {
                    ...
                    if (distance < corA.GetDistanceTo(corB))
                    {
                        ...
                        track1 = locations[locA];
                        track2 = locations[locB];
            ...
            Console.WriteLine("the two furthest distance are");
            Console.WriteLine(track1.Name);
            Console.WriteLine(track2.Name);
            Console.WriteLine($"With a distance of {distance} meters and a distance of {distance * 0.00062137} miles");
